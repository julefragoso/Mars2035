  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        mars: "bg-gradient-to-r from-mars-rust to-mars-oxide text-primary-foreground hover:from-mars-glow hover:to-mars-rust hover:shadow-lg border-0 font-medium tracking-wide",
        minimal: "bg-transparent border border-mars-rust text-mars-rust hover:bg-mars-rust hover:text-primary-foreground font-mono text-xs uppercase tracking-wider",
      },
      size: {
